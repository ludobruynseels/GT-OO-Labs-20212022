/**
 * A class representing a quiz with one multiple-choice question with three possible answers
 */
public class Quiz
{
    /**
    ...
    /**
     * Processes an answer to the question. First this method tests whether the answer is between 1 and 3, and then it prints an output based on whether the given answer was correct.
     */
    ...
    /**
     * Compares a given answer with the correct one to determine whether the answer was correct. This method returns true if the answer was correct, false otherwise.
     * Note: this method is private, so it does not appear in the method list if you create an object an right-click it!
     */
